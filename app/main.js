...
function initializeRouter() {
    // app.mvc.router = what is exported from app.js
    ...
    // Fonction fléché ES6.
    // Obj : Envoyer le controller 'Home' dans ce cas, vers la vue.
    ...
    // équivalent de redirectToRoute dans symfony.
    // app.mvc.router.navigateTo('hello/World');

    // Vérifie sur quelle route je suis.
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Ajoutez dans l'écouteur d'évenement DOMContentLoaded (dans le fichier app/main.js)

    // Si le navigateur client supporte les services workers, alors on installe le notre
